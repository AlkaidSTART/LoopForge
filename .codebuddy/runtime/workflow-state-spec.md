...
> 注意：v1.3 移除了 TASK-01 阶段（需求分析已合并进 Main Agent Step 2.5）、新增 CODE-REVIEW 阶段。各阶段完成后直接流转下一阶段（不经 leader 产物审核）。medium/large 在 TASK-05 后由 leader 汇总，small 由 solo-developer 自行汇总。
