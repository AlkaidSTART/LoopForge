...
```
Cursor agent job: name="sub-developer-PT-01",
     role_name="developer", prompt=<sub-prompt for PT-01>)
Cursor agent job: name="sub-developer-PT-02",
...
完成后：
```
返回主 Cursor 线程：event=TASK-03_completed，summary="TASK-03_completed"
```
...
```
Cursor agent job: name="sub-developer-PT-XX",
